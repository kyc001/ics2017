...
opcode_entry opcode_table [512] = {
  ...
  /* 0x28 */	IDEXW(G2E, sub, 1), IDEX(G2E, sub), EX(seg_override), IDEX(E2G, sub),
  /* 0x2c */	IDEXW(I2a, sub, 1), IDEX(I2a, sub), EMPTY, EX(seg_override),
  ...
  /* 0x9c */	EX(pushf), EX(popf), EMPTY, EMPTY,
